    ...
    <div>
      <div className=" relative w-full md:h-screen flex flex-col md:flex-row bg-slate-500 overflow-hidden">
        <div className="w-full relative">
          ...
          <Image
            src={`https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w01/cover.jpg`}
            alt="image"
            width={200}
            height={200}
            priority={false}
      ...
      <div className="flex flex-col md:flex-row justify-between  my-10 w-10/12 mx-auto gap-6 md:gap-0">
        <div className="md:w-1/2 w-full   relative group/p01 cursor-pointer">
          <div className="w-full overflow-hidden   " data-aos="fade">
            <Image
              src="https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w01/p01.jpg"
              alt="image"
              width={200}
              height={200}
              priority={false}
        ...
        <div className="md:w-1/2 w-full   relative group/p01 cursor-pointer">
          <div className="w-full overflow-hidden   " data-aos="fade">
            <Image
              src="https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w01/p02.jpg"
              alt="image"
              width={200}
              height={200}
              priority={false}
      ...
      <div>
        <div className="w-full overflow-hidden   " data-aos="fade">
          <Image
            src="https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w01/p03.jpg"
            alt="image"
            width={200}
            height={200}
            priority={false}
        ...
        <div className="work-text-under-img">
          總長200
          米木棧板步道，以自然質感銜接室內的舒適與戶外的陽光，引導居者透過雙腳行走徜徉於光影之中，用身體感知捕捉四季溫度。
        </div>
      </div>
      ...
      <div>
        <div className="w-full overflow-hidden   " data-aos="fade">
          <Image
            src="https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w01/p04.jpg"
            alt="image"
            width={200}
            height={200}
            priority={false}
