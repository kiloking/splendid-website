    ...
    <div>
      <div className=" relative w-full md:h-screen flex flex-col md:flex-row bg-slate-500 overflow-hidden">
        <div className="w-full relative">
          ...
          <Image
            src={`https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w02/cover.jpg`}
            alt="image"
            width={200}
            height={200}
            priority={false}
          ...
          <div className=" absolute z-10 text-white bottom-5 md:text-3xl font-thin w-3/4 md:w-2/3  text-right right-5">
            坐收萬坪公園的翠綠蓊鬱，Dali Art
            國際藝術村環抱其中，「森自在」以得天獨厚之姿為住戶提供高氧綠意的舒適環境，讓公園裡的晨跑、漫步，成為美好一天的開始。
          </div>
        </div>
      ...
      <div className="flex flex-col md:flex-row justify-between  my-10 w-10/12 mx-auto gap-6 md:gap-0 ">
        <div className="md:w-1/2 w-full   relative group/p01 cursor-pointer">
          <div className="w-full overflow-hidden   " data-aos="fade">
            <Image
              src="https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w02/p01.jpg"
              alt="image"
              width={200}
              height={200}
              priority={false}
          ...
          <div className="work-text-under-img">
            藉由木質主題與兩旁的「東湖公園」及「青年公園」榫接，以獨特樹木剪影包覆建築外觀，創造於公園樹海及創藝能量之間的自然居遊。
          </div>
        </div>
        <div className="md:w-1/2 w-full   relative group/p01 cursor-pointer">
          <div className="w-full overflow-hidden   " data-aos="fade">
            <Image
              src="https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w02/p02.jpg"
              alt="image"
              width={200}
              height={200}
              priority={false}
      ...
      <div>
        <div className="w-full overflow-hidden   " data-aos="fade">
          <Image
            src="https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w02/p03.jpg"
            alt="image"
            width={200}
            height={200}
            priority={false}
