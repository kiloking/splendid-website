    ...
    <div >
      <div className=' relative w-full h-screen flex bg-slate-500 overflow-hidden'>
        <div className='w-full relative'>
          ...
          <Image src={`https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w04/cover.jpg`} alt="image" 
          ...
          「單純」是一道淬鍊的歷程。「大漁ONE PLUS」 以經典垂直柱列直上穹頂，搭配金屬格柵，承襲現代主義的內斂大方。延續大漁ONE精品住宅的理念，ONE PLUS以更精簡淬鍊的質感，實現Bigger than ONE 的美學高度與生活想像。
          </div>
        </div>
      ...
      <div className='flex justify-between  my-10 w-10/12 mx-auto'>
        <div className='w-1/2   relative group/p01 cursor-pointer'>
          <div className='w-full overflow-hidden   ' data-aos="fade">
            <Image src='https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w04/p01.jpg' alt="image" 
              width={200} height={200} priority={false} 
              layout="responsive" 
              objectFit="cover"
          ...
          成熟的風格美學，是低調不減奢華。大漁ONE PLUS彈性公共空間結合藝術大廳、生活講堂、收信區、吧台，讓品味生活一體成型，開創住居無界的質感體驗。</div>
        </div>
        <div className='w-1/2   relative group/p01 cursor-pointer'>
          <div className='w-full overflow-hidden   ' data-aos="fade">
            <Image src='https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w04/p02.jpg' alt="image" 
              width={200} height={200} priority={false} 
              layout="responsive" 
              objectFit="cover"
              className="w-full h-full group-hover/p01:scale-110 transition-all duration-500"
          ...
          <div className='text-lg mt-3 font-semibold text-black/80'>
          極簡石材搭配大尺度框景，天際視野的sky lounge結合舒適氛圍與市區美景，讓聚會小酌、佳節賞月，都能俐落演繹都會品味。
          </div>
        </div>
      </div>
      ...
      <div>
        <div className='w-full overflow-hidden   ' data-aos="fade">
          <Image src='https://pub-a73f7d8384414e33a55eebf09fd805cd.r2.dev/w04/p03.jpg' alt="image" 
            width={200} height={200} priority={false} 
            layout="responsive" 
            objectFit="cover"
            className="w-full h-full group-hover/p01:scale-110 transition-all duration-500"
