    ...
    <div className='flex my-10 items-stretch gap-10'>
      ...
      <div className=' flex flex-col items-start gap-4  w-2/3'>
        ...
        <div className='flex flex-col gap-4'>
          <div className='text-5xl font-thin my-2'>人本，幸福住居</div>
          <div className='w-1/2'>
          ...
          <div className='text-black/80'>
            建築，是生活的延伸 ; 住宅，是幸福的所在。<br />
            大漁建設創立三十餘年，堅持以家的溫度思考居住。<br />
        ...
        <br />
        <div className='flex flex-col gap-4'>
          <div className='text-5xl font-thin my-2'>在地，溫度建築</div>
          <div className='w-1/2'>
        ...
        <br />
        <div className='flex flex-col gap-4'>
          <div className='text-5xl font-thin my-2'>大漁，匠心臻品</div>
          <div className='w-1/2'>
          ...
          <div className='text-black/80'>
          「大漁」源於日文漢字「大漁祝」，相信臻品建築能為幸福保值，如船隻滿載漁獲，為每一位住戶帶來豐收。<br />
