...
const History = () => {
  return (
    <div className='md:mt-[88px] px-10 md:px-20'>
      ...
      <div className='flex md:w-10/12 my-10 mx-auto items-stretch gap-10'>
        <div className=' flex flex-col items-start gap-4'>
          ...
          <div className='flex flex-col gap-20 mt-10'>
            <div className='w-full flex flex-col  md:flex-row items-end gap-5'>
              <div className='w-full md:w-1/2 leftBubble overflow-hidden'>
              ...
              <div className='md:w-1/2 text-black/80 flex flex-col gap-2'>
            ...
            <div className='w-full flex flex-col  md:flex-row items-end gap-5'>
              <div className='md:w-1/2 w-full md:order-2 rightBubble overflow-hidden'>
              ...
              <div className='md:w-1/2 w-full text-black/80 flex flex-col gap-2 md:order-1 text-right '>
            ...
            <div className='w-full flex flex-col md:flex-row items-end gap-5 '>
              <div className='md:w-1/2 w-full leftBubble overflow-hidden'>
              ...
              <div className='md:w-1/2 w-full text-black/80 flex flex-col gap-2'>
            ...
            <div className='w-full flex flex-col md:flex-row items-end gap-5'>
              ...
              <div className='md:w-1/2 text-black/80 flex flex-col gap-2 order01 text-right '>
